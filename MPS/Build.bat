...
g++ -c src/*.cpp -std=c++17 -Werror -Wfatal-errors -I include -I C:\libs\SFML-2.5.1\include
...
g++ -c src/*.cpp -std=c++17 -Werror -Wfatal-errors -I include  -I C:\libs\SFML-2.5.1\include -O3 -s -fexpensive-optimizations
